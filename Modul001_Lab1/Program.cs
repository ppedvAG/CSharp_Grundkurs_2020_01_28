...
namespace Modul001_Lab1
{
    class Program
    {
        //Teilnehmer haben das Wissen und die Word-Datei
        static void Main(string[] args)
        {
            ...
            #region Variablen Namingstile

            string vorname = "MaxMustermann";
            string zweiterVornameDenMannRueckwaertsLesen = string.Empty;

            string strZweiterVorname = string.Empty;
